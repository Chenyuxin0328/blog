<template>
  <el-form @submit.prevent="handleSubmit" class="form register-form" :model="form">
    ...
    <el-form-item class="form-item">
      <div class="input-wrapper">
        <label :class="['floating-label', { 'is-float': form.confirmPassword || isFocused.confirmPassword }]">
          确认密码
        </label>
        <el-input
